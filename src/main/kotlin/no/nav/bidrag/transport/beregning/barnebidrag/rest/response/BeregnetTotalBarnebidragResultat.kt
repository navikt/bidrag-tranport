...
data class BeregnetTotalBarnebidragResultat(
  ...
  constructor(
    beregnetBarnebidragResultat: BeregnetBarnebidragResultatCore,
    grunnlagListe: List<ResultatGrunnlag>
  ) : this(
    beregnetBarnebidragPeriodeListe = beregnetBarnebidragResultat.resultatPeriodeListe.map {
      ResultatPeriode(
        it
      )
    },

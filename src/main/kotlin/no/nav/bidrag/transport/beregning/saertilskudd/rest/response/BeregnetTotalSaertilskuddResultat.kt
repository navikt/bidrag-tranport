...
data class BeregnetTotalSaertilskuddResultat(
  ...
  constructor(
    beregnetSaertilskuddResultatCore: BeregnSaertilskuddResultatCore,
    grunnlagListe: List<Grunnlag>
  ) : this(
    beregnetSaertilskuddPeriodeListe = beregnetSaertilskuddResultatCore.resultatPeriodeListe.map {
      ResultatPeriode(
        it
      )
    },
